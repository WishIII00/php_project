...
<h1>ระบบซ่อมคอมพิวเตอร์ <?php echo $ivtrid == '' ? 'Add' : ''; ?> เพิ่มข้อมูลอุปกรณ์การซ่อม</h1>
     <form method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="ivtrprice" class="form-label">ราคา</label>
            <input name="ivtrprice" type="text" class="form-control" id="ivtrprice" value="<?php echo empty($ivtrid) ? '' : $rowitem["ivtrprice"]; ?>">
        </div>
