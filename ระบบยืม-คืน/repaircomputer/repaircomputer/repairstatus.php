...
<body class = "container-fluid">
    <h1>สถานะแจ้งซ่อมคอมพิวเตอร์</h1>
    <a class="btn btn-primary float-end bi-cart-plus" href="addrepairstatus.php" role="button"> แจ้งซ่อม </a>
        <form class="row row-cols-lg-auto g-3 align-items-center" method="get" action="">
            <div class="col-3">
                ...
                <select name="ssid" class="form-select" id="ssid">
                    <option value="">รหัสสถานะแจ้งซ่อม</option>
                    <?php 
    ...
    <p>รายการสถานะซ่อมทั้งหมด <?php echo $no;?> รายการ.</p>
