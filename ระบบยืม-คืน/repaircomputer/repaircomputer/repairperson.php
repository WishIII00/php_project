...
<body class = "container-fluid">
    <h1>ผู้แจ้งซ่อมคอมพิวเตอร์</h1>
    <a class="btn btn-primary float-end bi-cart-plus" href="addperson.php" role="button"> แจ้งซ่อม </a>
        <form class="row row-cols-lg-auto g-3 align-items-center" method="get" action="">
            <div class="col-3">
                ...
                <select name="psid" class="form-select" id="psid">
                    <option value="">ใบแจ้งซ่อม</option>
                    <?php 
    ...
    <p>รายการแจ้งซ่อมทั้งหมด <?php echo $no;?> รายการ.</p>
